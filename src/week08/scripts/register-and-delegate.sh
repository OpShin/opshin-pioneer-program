...
script=/workspace/src/week08/assets/staking/script.plutus
...
cardano-cli stake-address delegation-certificate \
    --stake-script-file $script \
    --stake-pool-id=$(/workspace/src/week08/scripts/query-stake-pools.sh | head -n 1) \
    --out-file $delegation
...
cardano-cli transaction build \
    ...
    --certificate-redeemer-file /workspace/src/week08/assets/unit.json \
